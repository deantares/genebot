 ...
 * @author antares
 */
public class t_fitness_versus2 extends Thread {
    ...
    public t_fitness_versus2(individuo t, String f) {
        // store parameter for later user
        tio = t;
        file = f;
    }

    public t_fitness_versus2(individuo t1, individuo t2, String f) {
        tio = t1;
        tio2 = t2;
        file = f;
    }

    public t_fitness_versus2(individuo t, String f, sel_mapa m) {
        // store parameter for later user
        tio = t;
        file = f;
        mapas = m.cromo;
    ...
    public t_fitness_versus2(individuo t1, individuo t2, String f, sel_mapa m) {
        tio = t1;
        tio2 = t2;
        file = f;
        mapas = m.cromo;
    ...
    public void run() {
        ...
        for (int i = 0; i < mapas.length; i++) {
            ...
            try {
                ...
                ProcessBuilder pb;
                pb = new ProcessBuilder("./lanzar_versus2.sh", 
