 ...
 * @author antares
 */
public class t_fitness_versus2FloatMax extends Thread {
    ...
    public t_fitness_versus2FloatMax(individuo t, String f) {
        // store parameter for later user
        tio = t;
        file = f;
    }

    public t_fitness_versus2FloatMax(individuo t1, individuo t2, String f) {
        tio = t1;
        tio2 = t2;
        file = f;
    }

    public t_fitness_versus2FloatMax(individuo t, String f, sel_mapa m) {
        // store parameter for later user
        tio = t;
        file = f;
        mapas = m.cromo;
    ...
    public t_fitness_versus2FloatMax(individuo t1, individuo t2, String f, sel_mapa m) {
        tio = t1;
        tio2 = t2;
        file = f;
        mapas = m.cromo;
    ...
    public void run() {
        ...
        tio.turnos = tio.turnos + tio1_turnos[0] + tio1_turnos[1] + tio1_turnos[2] + tio1_turnos[3] + tio1_turnos[4];
        tio.puesto = tio.puesto + tio1_puesto[0] + tio1_puesto[1] + tio1_puesto[2] + tio1_puesto[3] + tio1_puesto[4];

        tio2.turnos = tio2.turnos + tio2_turnos[0] + tio2_turnos[1] + tio2_turnos[2] + tio2_turnos[3] + tio2_turnos[4] ;
        tio2.puesto = tio2.puesto + tio2_puesto[0] + tio2_puesto[1] + tio2_puesto[2] + tio2_puesto[3] + tio2_puesto[4];
