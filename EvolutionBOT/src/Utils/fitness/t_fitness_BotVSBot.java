 ...
 * @author antares
 */
public class t_fitness_BotVSBot extends Thread {

    public fitness_return resultado = new fitness_return();
    public individuo tio;
    public individuo tio2 = null;
    public String file;
    public int[] mapas = {76, 69, 7, 11, 26};

    public t_fitness_BotVSBot(individuo t, String f) {
        // store parameter for later user
        tio = t;
        file = f;
    }

    public t_fitness_BotVSBot(individuo t1, individuo t2, String f) {
        tio = t1;
        tio2 = t2;
        file = f;
    }

    public t_fitness_BotVSBot(individuo t, String f, sel_mapa m) {
        // store parameter for later user
        tio = t;
        file = f;
        mapas = m.cromo;
    ...
    public t_fitness_BotVSBot(individuo t1, individuo t2, String f, sel_mapa m) {
        tio = t1;
        tio2 = t2;
        file = f;
        mapas = m.cromo;
